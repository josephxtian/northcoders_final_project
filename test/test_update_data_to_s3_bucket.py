    ...
    def test_retreives_list_of_files(self):
        with mock_aws():
            ...
            def test_func(test_list):
                return [{'address_id': 1,'address_line_1': '6826 Herzog Via'},
                        {'address_id': 2,'address_line_1': '6827 Herzog Via'},
                        {'address_id': 3,'address_line_1': '6828 Herzog Via'}]
            
            bucket_name = 'test_bucket'
            object_key1 = "address/seed.json"
            object_key2 = "address/2025-02-27 12:13:32.json"
            file1 = '[{"address_id": 1,"address_line_1": "6826 Herzog Via"}]'
            file2 = '[{"address_id": 2,"address_line_1": "6827 Herzog Via"}]'
